window.onload = function() {
    ...
    let menu_data = [    
        new MakeMenu('회사소개', 'http://bluej1996.dothome.co.kr/', '인사말,STX건설,기업문화,STX건설연혁,조직안내,윤리경영,안전·환경·품질경영,찾아오시는 길', '#,#,#,#,#,#,#,#'),
        ...
        new MakeMenu('고객지원', 'http://bluej1996.dothome.co.kr/bbs/board.php?bo_table=test', '자주묻는질문, 고객문의', '#,#'),
